...
const GiveComponent: React.FC<{ pageData: GiveModel | null; pageContent: DocumentElement[] | undefined }> = ({ pageData, pageContent }) => {
  return (
    <div>
      ...
      <RevealSection id="kidsLeftImage">
        <Container className="reveal">
          <div className="story-container">
            {sectionContent.image ? <div className="story-image rounded" style={{ backgroundImage: `url("${sectionContent.image}")` }}></div> : null}
            <div>
