...
const AnglicanComponent: React.FC<{ pageData: AnglicanModel | null; pageContent: DocumentElement[] | undefined }> = ({ pageData, pageContent }) => {
  return (
    <div>
...
export default AnglicanComponent;
